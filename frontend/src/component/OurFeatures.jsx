...
const features = [
  { icon: Truck, text: "Paid Shipping", subtext: "On orders over ₹ 500" },
...
const OurFeatures = () => {
  return (
    <div className="bg-white border-t border-gray-200 py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-y-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-8">
          {features.map((feature, index) => {
            return (
              ...
              >
                <feature.icon
                  className="flex-shrink-0 h-10 w-10 text-gray-700"
                  aria-hidden="true"
                />
                <div className="ml-4">
